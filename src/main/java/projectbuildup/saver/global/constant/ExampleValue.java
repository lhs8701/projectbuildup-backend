package projectbuildup.saver.global.constant;

public class ExampleValue {
    public static class challenge{

        public static final String START_DATE = "23.10.10";
        public static final String END_DATE = "24.10.10";
        public static final String MAIN_TITLE = "main title";
        public static final String SUBTITLE = "subtitle";
        public static final String CONTENT = "content";
        public static final Long AMOUNT = 16000L;
    }
